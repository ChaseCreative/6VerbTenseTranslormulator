...
function userNounInput(){
  ...
  function startGame(){
    ...
    document.getElementById("label").innerHTML = "Please translate \"" + ranVerbForm[rVFindx][0] + "!\" (N.B. " + ranVerb.firstSingPres + ", " + ranVerb.actInfPres + ", " + ranVerb.firstSingPer + ", " + ranVerb.actInfPresTrans + ")";
    document.getElementById("submit").onclick = function(){checkAnswer()};
    // document.getElementById("label2").style.display = "none";
    latinForm = ranVerbForm[rVFindx][0].normalize('NFC').replace(/[\u0300-\u036f]/g, "");
    latinTrans = ranVerbForm[rVFindx][1].normalize('NFC').replace(/[\u0300-\u036f]/g, "");
    document.getElementById("textBox").value = " ";
  ...
  function checkAnswer(){
    ...
    if (answer.trim() == latinTrans.trim().toUpperCase()){
    // if (document.getElementById("textBox").value.toLowerCase() === latinForm.toLowerCase()){
      document.getElementById("label").innerHTML = "Nice! The correct translation of \"" + latinForm.trim() + "\" was \"" + latinTrans.trim() + ".\" Do you want to play again? (y/n)";
      score++;

    } else {
      document.getElementById("label").innerHTML = "Oops! You answered \"" + answer.trim() + ".\" The correct translation of \"" + latinForm.trim() + "\" was \"" + latinTrans.trim() + ".\" Do you want to play again? (y/n)";
